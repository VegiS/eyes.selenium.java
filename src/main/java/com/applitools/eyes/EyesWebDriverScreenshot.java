...
public class EyesWebDriverScreenshot extends EyesScreenshot {
    ...
    private static enum ScreenshotType {VIEWPORT, ENTIRE_FRAME}
    ...
    private static Location calcFrameLocationInScreenshot(Logger logger,
        ...
        logger.verbose("calcFrameLocationInScreenshot()");
        ...
        logger.verbose("calcFrameLocationInScreenshot done!");
     ...
     * @param image The actual screenshot image.
     *
     * @see #EyesWebDriverScreenshot(Logger, EyesWebDriver, java.awt.image.BufferedImage, com.applitools.eyes.EyesWebDriverScreenshot.ScreenshotType, Location)
    ...
    public EyesWebDriverScreenshot getSubScreenshot(Region region,
        ...
        logger.verbose("getSubScreenshot Done!");
        return result;
    }
